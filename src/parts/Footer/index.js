        ...
        <div className="border-t border-b border-gray-200 py-12 mt-16 px-4">
          ...
          <aside className="container mx-auto">
            <div className="flex flex-wrap md:space-x-4 justify-center">
              {/* ANCHOR Start Item aside menu 1 */}
              ...
              {/* ANCHOR End Item aside menu 1 */}

              {/* ANCHOR Start Item aside menu 2 */}
              <div className="w-full md:w-2/12 mb-4 md:mb-0 accordion">
              ...
              {/* ANCHOR End Item aside menu 2 */}

              {/* ANCHOR Start Item aside menu 3 */}
              <div className="w-full md:w-2/12 mb-4 md:mb-0 accordion">
              ...
              {/* ANCHOR End Item aside menu 3 */}

              {/* ANCHOR Start Item aside menu 4 */}
              ...
              {/* ANCHOR End Item aside menu 4 */}
            </div>
          </aside>
        </div>
      </section>
      {/* ANCHOR End Aside Menu */}
