    ...
    <section className="container mx-auto">
      <div className="flex flex-wrap my-4 md:my-12">
        ...
        <div className="flex-1 px-4 md:p-6">
          ...
          <a
            href="/"
            className="transition-all duration-200 bg-pink-400 text-black focus:bg-black focus:text-pink-400 rounded-full px-8 py-3 mt-4 inline-flex md:w-auto w-full justify-center"
          >
            <svg
          ...
          <h6 className="text-xl font-semibold mb-4">About the book:</h6>
          <p className="text-xl leading-7 mb-6">{data.description}</p>
        </div>
      </div>
    </section>
  );
